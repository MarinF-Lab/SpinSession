enum JobType {
  ...
  String get value => switch (this) {
        ...
        JobType.generatePrivateSession => 'generate_private_session',
  ...
  static JobType fromString(String v) => switch (v) {
        ...
        'generate_private_session' => generatePrivateSession,
  ...
  String get label => switch (this) {
        ...
        JobType.generatePrivateSession => 'Generando sesión privada',
